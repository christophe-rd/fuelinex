...
%DIF ADD proposal.tex      Fri Jan 23 17:30:41 2026
...
% --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
\begin{figure}[h!]
\includegraphics[width=0.4\textwidth]{chaptersDesign.pdf}
\caption{Overview of the age class, species, provenance of the trees used in each study along with the type of study each project consist of.}
