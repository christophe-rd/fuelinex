...
% --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
\begin{figure}[h!]
\includegraphics[width=0.85\textwidth]{chaptersDesign.pdf}
...
Here, I will focus on how the phenological season (2), incorporating the meteorological season (4), affects the true growing season (1), as our data cannot address the productive season (3). I will use the phenological season (2) to infer a ``window of opportunity", to calculate growing degree days (GDD)---a measure of heat accumulation---using meteorological conditions. \\
...
\alpha &\sim \text{Normal}(5, 3) \\
\alpha_{\text{species}} &\sim \text{Normal}(0, 6) \\
\alpha_{\text{site}} &\sim \text{Normal}(0, 2) \\
\alpha_{\text{treeid}} &\sim \text{Normal}(0, \sigma_{\alpha \, \text{treeid}}) \\
\beta_{\text{species}} &\sim \text{Normal}(0, 0.5) \\
\sigma_{\alpha \, \text{treeid}} & \sim \text{Normal}(0, 0.5) \\
...
\begin{aligned}
ringwidth_i &\sim \text{Normal}(\mu, \sigma_y) \\
\mu &= \alpha + \alpha_{\text{species}} + \alpha_{\text{treeid}} + \beta_{species}* gdd \\
\alpha &\sim \text{Normal}(2, 3) \\
\alpha_{\text{species}} &\sim \text{Normal}(0, 6) \\
\alpha_{\text{treeid}} &\sim \text{Normal}(0, \sigma_{\alpha \, \text{treeid}}) \\
\beta_{\text{species}} &\sim \text{Normal}(0, 1) \\
\sigma_{\alpha \, \text{treeid}} & \sim \text{Normal}(0, 2) \\
...
\hline
7 June 2024 & 62.5 mL & 62.5 mL\\
6 July 2024 & 62.5 mL & 62.5 mL \\
1 Sept 2024 & 250 mL& 0 mL\\
\hline
\textbf{Subtotal (2024)} & \textbf{375} & \textbf{125} \\
\hline
 &  &  \\
\hline
10 April 2025 & 0 mL& 125 mL\\
9 May 2025 & 0 mL& 125 mL\\
\textit{June 2025} & 62.5 mL& 62.5 mL\\
\textit{July 2025} & 62.5 mL& 62.5 mL\\
\hline
\textbf{Subtotal (2025)} & \textbf{125 mL} & \textbf{375 mL} \\
\hline
 &  &  \\
\hline
\textbf{2-year total} & \textbf{500 mL} & \textbf{500 mL} \\
\hline
\end{tabular}
\end{table}
