...
\textbf{} & \multicolumn{1}{c|}{\textbf{}} \\
\hline
\textbf{Mechanisms} & — Hot temperature + low precipitation (i.e. global-change-type drought)= $\uparrow$ evapotranspiration$\rightarrow$ less water in soil $\rightarrow$ cavitation $\rightarrow$ embolism $\rightarrow$ hydraulic failure (Tyree02) = tissue death (Choat18); 
...
— Long-term vs short-term stomatal responses and consequences on tissue death (Choat18); 

— Recovery and its determinants (Choat18; Li23)\\
\hline
