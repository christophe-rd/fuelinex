...
% ============================
\subsection{Nature of the problem}  %emwJuly1 -- somewhere before here or here you need to say why to care. You could possibly end the previous section with that (like, 'clearly these impacts will have wide reaching effects on forest ecosystems and their services  .... ') 
\begin{enumerate}
