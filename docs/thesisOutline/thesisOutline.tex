...
% 4)
	\item How these shifts translate into effects on trees/forests not totally clear -- Pros and cons of early/late start of season: \\  % Goal is to organize potential positive and negative consequences %emwJuly1 -- good, but what's the topic sentence for the audience? You just went through what's changing ... I think your topic here is 'how these shifts translate into effects on trees/forests' so I added that 
		\textbf{Early SOS}\\
		\textit{Pros} 
			\begin {itemize}
				...
				\item More days to reach fruit maturity (REF). %emwJuly1 -- I suggest you ask Victor, this is commonly invoked in PHENOFIT
			\end {itemize}
		\textit{Cons}: 
			\begin {itemize}
...
% ============================
\subsection{Nature of the problem and to address it}  %emwJuly1 -- somewhere before here or here you need to say why to care. You could possibly end the previous section with that (like, 'clearly these impacts will have wide reaching effects on forest ecosystems and their services  .... ') 
\begin{enumerate}
	...
	\item Goals of my thesis
		...
		\end{itemize}
\end{enumerate} %emwJuly1 -- somewhere before next section you should maybe state what you will do or look at for your thesis in a very broad way (more broad than objectives later). Can be just one sentence that says this and then you can say you'll mainly use tree rings? But you will use other metrics so not sure how rings will fit as such a long section here. You could make the below section a subsection of a later chapter and just pull out the big points in your thesis outline intro here. 
