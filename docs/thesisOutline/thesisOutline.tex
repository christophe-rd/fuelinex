...
\textbf{1.2.2. Trends of spring and autumn phenological events and their drivers \citep{walther_ecological_2002} } \\
	1.2.2.1. changes in phenology \\ 
	1.2.2.2. Drivers of spring phenology (including forcing and chilling from paragraph of declining sensitivity) \\
	1.2.2.3. Drivers of autumn phenology \\ 

\textbf{1.2.3. How these shifts translate into effects on trees/forests not totally clear -- Pros and cons of early/late start of season:} \\  

\textbf{1.2.4.Growing season shifts consequences on forest ecosystems and services }
...
\textbf{1.2.2. The assumption that longer seasons lead to increased growth is called into question} \\ 
	1.2.2.1. Absence of growth despite better conditions and strategies that can be used  \\
	1.2.2.2. Experiments \\ 
	1.2.2.3. Ground based observations \\
\textbf{1.2.3. Goals of my thesis}

\subsection{1.2.4. Complexity of measuring growth}
\textbf{1.2.4.1. Definine growing season and growth}
\textbf{1.2.4.1. Traditional diameter measurements miss the resolution of the annual growth increment}
\textbf{1.2.4.1. Primary and secondary growth do not start and end at the same time}
