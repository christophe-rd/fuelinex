...
% CHAPTER 1 %
%<><><><><><><><><><><><><><><><><><><><>
\textbf{Chapter 1. Continuation of the extended growing season experiment}:
Shifts in phenological phases have consequences for growth during the current growing season---a hypothesis I tested previously in my thesis---but experiments to date have not quantified whether longer seasons have lagging effects over subsequent years \cite{chapin_ecology_1990,landhausser_partitioning_2012,lawrence_variable_2018,martens_first-year_2007,schott_premature_2013}. My objective for this first chapter is to complete an additional project I conducted during my MSc but deliberately set aside from my thesis. In fall 2025, I completed a large-scale growing season length experiment using 15 replicates of seven species over two consecutive years, assessing different tree species' potential to stretch their activity schedules and whether this translates into increased growth over multiple growing seasons. In the first year of my proposed award tenure, I will leverage the tens of thousands of observations I collected in 2024 and 2025, analysing these data using a sophisticated joint Bayesian hierarchical model. Developing this complex tree growth model will build on an ongoing collaboration with Dr. Charles Margossian, a statistician and expert in Bayesian inference. While mostly computational, this first chapter will allow me to robustly test whether tree growth is driven by multi-year conditions, providing the field with a crucial modelling tool to test this hypothesis in natural systems \cite{silvestro_longer_2023}.
