...
For senescence, Since I copy paste the spreadsheets, for nogreenleaves and last leaves fell, find a way to always select the first time there is a "y", so we know when this stage was reached. 
**DO NOT** use the doy column to indicate the two green leaf and last leaves fell columns as they are wrong. Y for both indicates that they are at that stage.