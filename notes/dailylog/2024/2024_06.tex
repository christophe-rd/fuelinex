...
\begin {itemize}
	...
	\item contact opens lab to trouble shoot the dendrometers
\end {itemize}
\par in the afternoon, I met with Fredi for 2 hours to discuss many things I have yet to answer. All the notes are in my obsidian folder. I finished the day with some quick questions I asked Lizzie. One of them was in regards to using the tidyverse. She recommends not using it if there is a way with base R because it's less future proof and running pieces of code by itself isn't good.
\par Then, we went to get icecream and beers.  
