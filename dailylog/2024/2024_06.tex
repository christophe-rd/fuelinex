...
\textbf {Christophe}
\begin{itemize}
	\item check new hobo sensors 
	\item update the greenhouse arrangement with all the new loggers
	\item make sure irrigation is back on -- done
	\item start writing up the methodology on hobo loggers and fertilizer
	\item shoot elongation protocole
	\item DEFENETILY do the apical shoot death monitoring
	\item update git issue on this
	\item Write to Mao to tell her what she will need to do
	\item phenomonitoring
	\ltem load shoot elongation measurements in excel file
	\item write to Lizzie and colleagues to tell them that I won't be checking my email 
	...
	\item Email Lizzie about her class
	\item return book to Amazon
	\item Add notes to the labgit on chambers
	\item email Melina regarding the greenhouse
	\item Inventory of trees outside at Totem
	\item Clean up the mess at Totem
\end{itemize}
